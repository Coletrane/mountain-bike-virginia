        ...
        content: [
          {
            p: [
              {
                words: "Upon being a convert to the church of the DW Link, my interest in Pivot Cycles far outmatches many other companies. Attending the Pivot demo was a must, for I yearned to know if the secret sauce tasted just as good on a different sandwich."
              }
            ]
          },
          {
