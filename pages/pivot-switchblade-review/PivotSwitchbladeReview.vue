...
<script>
  ...
  export default {
    ...
    data() {
      return {
        headerHeight: 700,
        img: this.s3 + '/pages/pivot-switchblade-review/',
        post: post,
