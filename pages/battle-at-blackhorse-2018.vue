<template>
  <div>
    <!--<blog-post :header-height="600"-->
               ...
               <!--:post="$store.state.posts[battleAtBlackhorse2018]"-->
               <!--no-title-->
      ...
      <!--<div slot="content">-->
        ...
        <!--<div class="blog-p">-->
          <!--Sundays event featured 23 miles and 4,600 feet of mixed singletrack, fire road, goat path, parkway and maybe a little good ol’ fashioned gnar. Riding out of Day Creek on the Glenwood Horse Trail traversing and slowly climbing the mountain side for about 4miles the riders reached the start of Stage 1. Dropping down from the side of Gel Ridge to Bobblets Gap Road the narrow off cambers, tight turns and wet leaves proved treacherous for many despite the lack of harsh gradient.-->
        <!--</div>-->

        <!--<div class="blog-p">-->
          <!--Following a classic Virginia fire road climb up to the parkway the blistering speed and sheer joy of the little-known Hammond Hollow Trail lay in wait. A sneaky lung buster climb interrupted the mach stupid blast down the mountain that tested the bravado of those daring enough to stay off the brakes.-->
        <!--</div>-->
        <!--<blog-image :src="img + 'P1000160.jpg'"/>-->
        <!--<blog-image :src="img + 'P1010111.jpg'"/>-->
        <!--<blog-image :src="img + 'P1000215.jpg'"/>-->
        <!--<div class="blog-p">-->
          <!--The last stage was a classic long haul down Dody Ridge featuring the steepest chutes of the day, a significant drop (that was still sent by a carbon hardtail wielding savage!), loose rock gardens and a finishing straight in effectively a boulder filled creek bed. Times were almost double the previous stages on this more enduro than the most enduro branded EWS endorsed convertible lid on the market deciding the finial times of the day.-->
        <!--</div>-->
        ...
        <!--<div class="blog-p">-->
          <!--Finishing out the highlight of everyone’s weekend was a gathering of dudes and dudettes in the parking lot while Kyle Imman cooked up dogs and Ken Lee and crew figured up some podiums.-->
        <!--</div>-->
        <!--<blog-image :src="img + 'P1000340.jpg'"/>-->
        <!--<div class="blog-p">-->
          <!--Lucas Weaver took home the W with a sizzling total time of 13:52 posting the fastest times on both stage 2 and 3! Miach Fontz rode into a super solid second place despite being miles from his native boat county. Buffalo Man himself, Matt Clements did it for Dale at #3. Rob Hobson and Andrew Issem rounded out the top 5.-->
        <!--</div>-->
...
<script>
  ...
  export default {
    ...
    head() {
      if (this.$store.state.posts[battleAtBlackhorse2018]) {
        return headTags(
          'Battle at Blackhorse 2018',
          this.$store.state.posts[battleAtBlackhorse2018].description,
          ...
          this.$store.state.posts[battleAtBlackhorse2018]
        )
      }
    },
    data() {
